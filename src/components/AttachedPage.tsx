...
export default function AttachedPage() {
  return (
          ...
          <div className="dark-bento-grid">
            ...
            <div className="dark-bento-card glow-green">
              ...
              <div className="assurance-card-body">
                {/* Chatbot Pane */}
                <div className="chatbot-pane glow-green-border">
                  ...
                  <div className="chat-bubble-ai">
                    I monitor your books continuously and flags anomalies and risks before they come problems.
                  </div>
                ...
                <div className="journal-pane">
                  ...
                  <table className="journal-mini-table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>3601 - Elim Variance</td>
                        <td>Auto-elim: Adjustment...</td>
                        <td>Elimination</td>
                        <td>USD</td>
                        <td>155,...</td>
                      </tr>
